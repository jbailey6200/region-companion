      ...
      <>
        <div className="summary-row">
          <div className="summary-card">
            <h3>
              Current Patron
              <InfoButton title="Patron Deity">
                <p>Your faction's patron deity provides divine blessings and unique bonuses.</p>
                <p>Each deity offers different benefits based on your regions, troops, or playstyle.</p>
                <p>You can change your patron at any time from this tab.</p>
              </InfoButton>
            </h3>
            <p>
    ...
    <div className="container">
      ...
      <div className="summary-row">
        <div className="summary-card">
          <h3>
            Economy
            <InfoButton title="Economy Overview">
              <p>Your faction's gold income and expenses each turn.</p>
              <p><strong>Income sources:</strong></p>
              <ul>
                <li>Towns: 2g each</li>
                <li>Cities: 5g each</li>
                <li>Mines: varies by type</li>
                <li>Court positions & religion bonuses</li>
              </ul>
              <p><strong>Expenses:</strong> Troop upkeep, agent upkeep, fortification maintenance.</p>
            </InfoButton>
          </h3>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginTop: 8, paddingTop: 8, borderTop: "1px solid #3a2f24" }}>
            <span style={{ color: "#c7bca5" }}>
              Manpower
              <InfoButton title="Manpower" size="small">
                <p>Manpower represents your workforce.</p>
                <p>Used to staff positions in your farms and mines.</p>
                <p>Generated by your settlements: 10 per village, 20 per town, and 30 per city.</p>
              </InfoButton>
            </span>
        ...
        <div className="summary-card">
          <h3>
            Military Capacity
            <InfoButton title="Military Capacity">
              <p><strong>HSG: Household Guard:</strong> Your professional troops. Cap can be raised by building settlements or fortifications</p>
              <p><strong>Levy:</strong> Peasant militia called up in times of war. Cheaper but weaker.</p>
              <p>If you are ever over either cap, you have to dismiss troops before end of turn!</p>
            </InfoButton>
          </h3>
        ...
        <>
          <div className="summary-row">
            <div className="summary-card">
              <h3>
                Warships
                <InfoButton title="Warships">
                  <p>Naval vessels for controlling sea lanes and transporting troops.</p>
                  <p><strong>Upkeep:</strong> {getModifiedUpkeep("warships", 3, patronDeity)}g per warship per turn.</p>
                  <p>Required for naval combat and amphibious operations.</p>
                </InfoButton>
              </h3>
              <p>
            ...
            {courtBonuses.positions.some((p) => p.position === "Lord Marshal") && (
              <div className="summary-card">
                <h3>
                  Army Capacity
                  <InfoButton title="Army Capacity">
                    <p>The maximum number of armies your faction can maintain.</p>
                    <p>Base capacity is 3 armies.</p>
                    <p>The <strong>Lord Marshal</strong> court position increases this limit.</p>
                  </InfoButton>
                </h3>
            ...
            <>
              <div className="summary-row">
                <div className="summary-card">
                  <h3>
                    Agent Capacity
                    <InfoButton title="Agent Capacity">
                      <p>Maximum agents you can employ, based on your settlements:</p>
                      <ul>
                        <li><strong>Town:</strong> +1 agent slot</li>
                        <li><strong>City:</strong> +2 agent slots</li>
                      </ul>
                      <p>Build more settlements to increase your agent capacity.</p>
                    </InfoButton>
                  </h3>
                  <p>
                ...
                <div className="summary-card">
                  <h3>
                    Agent Upkeep
                    <InfoButton title="Agent Types & Costs">
                      <p><strong>Spy (1g/turn):</strong> Gathers intelligence, reveals enemy agents and armies.</p>
                      <p><strong>Agitator ({getModifiedUpkeep("agitator", 4, patronDeity)}g/turn):</strong> Incites unrest, lowers loyalty, spreads propaganda.</p>
                      <p><strong>Enforcer (2g/turn):</strong> Eliminates threats, protects your agents, suppresses unrest.</p>
                      <p>Agents can move 2 hexes per turn and level up through successful missions.</p>
                    </InfoButton>
                  </h3>
                  <p>
